 ...
 */
class PinController extends BroadcastReceiver {
    private String _ok;
    ...
    private void check() {
        ...
        if (activity != null) {
            ...
            LocalBroadcastManager.getInstance(activity).registerReceiver(this,
                    new IntentFilter(Constants.EVENT_PONG));


            Intent intent = new Intent(Constants.EVENT_PING);
            intent.putExtra(Constants.EVENT_CONTENT, userEntered);
    ...
    private void onError() {
        ...
        new LockKeyPadOperation(PinController.this).execute("");
    }
    ...
    private void endInit() {
        ...
        View.OnClickListener pinButtonHandler = new View.OnClickListener() {
            public void onClick(View v) {
                PinController.this.onClick((Button) v);
            }
        };
